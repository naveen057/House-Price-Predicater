...
bathrooms = st.number_input('No. of bathrooms', min_value=0.5, max_value=10.0, value=2.0, step=0.5)
...
grade = st.slider("Select the house grade (1-13)", min_value=1, max_value=13, value=7)
